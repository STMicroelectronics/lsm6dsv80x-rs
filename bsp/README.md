# Examples for LSM6DSV80X Sensor
...
- hg_wakeup.rs — Wakeup detection with high-g.
...
- lsm6dsv80x_glance.json
- lsm6dsv80x_fourd_orientation.json
- lsm6dsv80x_gym_activity_recognition_right.json
