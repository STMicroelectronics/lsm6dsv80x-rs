...
- The sensor is configured by applying a sequence of register writes and delays generated by the **`ucf-tool`** from a UCF file (`lsm6dsv80x_glance_detection.ucf`), which programs the sensor's FSM for gesture detection.
